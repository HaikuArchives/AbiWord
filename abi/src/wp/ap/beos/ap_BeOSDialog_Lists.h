...
public:
    ...
    virtual void            notifyActiveFrame(XAP_Frame *pFrame) {UT_ASSERT(UT_NOT_IMPLEMENTED); };
	virtual void      		setFoldLevelInGUI(void) {UT_ASSERT(UT_NOT_IMPLEMENTED); };
	virtual bool      		isPageLists(void) {UT_ASSERT(UT_NOT_IMPLEMENTED); };
	/*	
