...
//
	...
	if(sdh != NULL)
	{
		...
		if(pSectionAP != NULL)
		{
		     if(pSectionAP->getAttribute("header-even",(const XML_Char *&)pszAtt))
		     {
		          _rtf_keyword("facingp"); // Allow odd-even headers/footers
		     }
		     else if(pSectionAP->getAttribute("footer-even",(const XML_Char *&)pszAtt))
		     {
		          _rtf_keyword("facingp"); // Allow odd-even headers/footers
		     }
		     if(pSectionAP->getAttribute("header-first",(const XML_Char *&)pszAtt))
		     {
			 _rtf_keyword("titlepg"); // Allow first page headers/footers
		     }
		     else if(pSectionAP->getAttribute("footer-first",(const XML_Char *&)pszAtt))
		     {
			 _rtf_keyword("titlepg"); // Allow first page headers/footers
		     }
		}
