...
#include "xap_BeOSDlg_DocComparison.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * XAP_BeOSDialog_DocComparison::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_BeOSDialog_DocComparison * p = new XAP_BeOSDialog_DocComparison(pFactory,id);
	return p;
}

XAP_BeOSDialog_DocComparison::XAP_BeOSDialog_DocComparison(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_DocComparison(pDlgFactory,id)
{
}

XAP_BeOSDialog_DocComparison::~XAP_BeOSDialog_DocComparison(void)
{
}

void XAP_BeOSDialog_DocComparison::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
