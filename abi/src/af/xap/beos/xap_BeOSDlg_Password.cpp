...
#include "xap_BeOSDlg_Password.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * XAP_BeOSDialog_Password::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_BeOSDialog_Password * p = new XAP_BeOSDialog_Password(pFactory,id);
	return p;
}

XAP_BeOSDialog_Password::XAP_BeOSDialog_Password(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_Password(pDlgFactory,id)
{
}

XAP_BeOSDialog_Password::~XAP_BeOSDialog_Password(void)
{
}

void XAP_BeOSDialog_Password::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
