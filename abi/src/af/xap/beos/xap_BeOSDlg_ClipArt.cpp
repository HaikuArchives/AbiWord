...
#include "xap_BeOSDlg_ClipArt.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * XAP_BeOSDialog_ClipArt::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_BeOSDialog_ClipArt * p = new XAP_BeOSDialog_ClipArt(pFactory,id);
	return p;
}

XAP_BeOSDialog_ClipArt::XAP_BeOSDialog_ClipArt(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_ClipArt(pDlgFactory,id)
{
}

XAP_BeOSDialog_ClipArt::~XAP_BeOSDialog_ClipArt(void)
{
}

void XAP_BeOSDialog_ClipArt::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
