...
// Modified for AbiWord by Martin Sevior (2003), from cryptlib 5.1
#include "ut_crc32.h"
#include <string.h>

/* Table of CRC-32's of all single byte values (made by makecrc.c) */
const UT_uint32 UT_CRC32::m_tab[] = {
...
{
        UT_uint32 n = strlen(s);
        Fill(reinterpret_cast<const unsigned char *>(s),n);
}

void UT_CRC32::Fill(const char *s, UT_uint32 n)
{
        Fill(reinterpret_cast<const unsigned char *>(s),n);
}
